        ...
        <>
            <header className="flex h-auto shrink-0 items-center justify-between border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 px-6 py-3 sm:h-16">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-slate-800 dark:text-white">Team Chat 💬</h2>
                        {currentUser && (
            ...
            <main className="flex-1 flex flex-col overflow-hidden bg-[#e5ddd5] dark:bg-[#0b141a] relative">
